 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_carray_to_py_int(__pyx_v_self->_pass_cnt, 2); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyBool_FromLong(__pyx_v_self->_player_auto); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_self->_player_clr); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyInt_From_std_3a__3a_uint64_t(__pyx_v_self->reversible); if (unlikely(!__pyx_t_7)) __PYX_ERR(1, 5, __pyx_L1_error)
  ...
  PyTuple_SET_ITEM(__pyx_t_9, 2, __pyx_v_self->_board_back);
  __Pyx_INCREF(__pyx_v_self->_board_log);
  __Pyx_GIVEREF(__pyx_v_self->_board_log);
  PyTuple_SET_ITEM(__pyx_t_9, 3, __pyx_v_self->_board_log);
 ...
 */
  /*else*/ {
    ...
    __pyx_t_12 = (__pyx_v_self->_board_log != Py_None);
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __Pyx_GetModuleGlobalName(__pyx_t_7, __pyx_n_s_pyx_unpickle_OthelloGameC); if (unlikely(!__pyx_t_7)) __PYX_ERR(1, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
 ...
 */
  ...
  if (unlikely(__Pyx_carray_from_py_int(PyTuple_GET_ITEM(__pyx_v___pyx_state, 4), __pyx_t_3, 2) < 0)) __PYX_ERR(1, 12, __pyx_L1_error)
  memcpy(&(__pyx_v___pyx_result->_disk_count[0]), __pyx_t_3, sizeof(__pyx_v___pyx_result->_disk_count[0]) * (2));
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(1, 12, __pyx_L1_error)
  }
  if (unlikely(__Pyx_carray_from_py_int(PyTuple_GET_ITEM(__pyx_v___pyx_state, 5), __pyx_t_3, 2) < 0)) __PYX_ERR(1, 12, __pyx_L1_error)
  memcpy(&(__pyx_v___pyx_result->_pass_cnt[0]), __pyx_t_3, sizeof(__pyx_v___pyx_result->_pass_cnt[0]) * (2));
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(1, 12, __pyx_L1_error)
  }
  __pyx_t_4 = __Pyx_PyObject_IsTrue(PyTuple_GET_ITEM(__pyx_v___pyx_state, 6)); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 12, __pyx_L1_error)
